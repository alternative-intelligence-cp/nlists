; ModuleID = 'test_load.npk'
source_filename = "test_load.npk"
...
entry:
  ...
  %ptr = call ptr @npk_alloc(i64 8)
  %wild_ptr = call ptr @npk_alloc(i64 32)
  store ptr %wild_ptr, ptr %ptr, align 8
  %val_any = alloca i64, align 8
  %ptr1 = load ptr, ptr %ptr, align 8
  %null.deref = icmp eq ptr %ptr1, null
...
null.ok:                                          ; preds = %entry
  ...
  store i64 %cast.sext, ptr %val_any, align 4
  %ptr2 = load ptr, ptr %ptr, align 8
  call void @npk_free(ptr %ptr2)
  %val_any3 = load i64, ptr %val_any, align 4
  %cast.trunc = trunc i64 %val_any3 to i32
  ret i32 %cast.trunc
}
...
define linkonce_odr i32 @__test_load_init() {
entry:
  ret i32 0
}
