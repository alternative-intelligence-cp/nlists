; ModuleID = 'bench/test_load_parens.npk'
source_filename = "bench/test_load_parens.npk"
...
null.ok:                                          ; preds = %entry
  ...
  store i64 %init_sext, ptr %val, align 4
...
define linkonce_odr i32 @__test_load_parens_init() {
entry:
  ret i32 0
}
