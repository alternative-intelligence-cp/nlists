; ModuleID = 'bench/test_store4.npk'
source_filename = "bench/test_store4.npk"
...
entry:
  ...
  %cast.ptrtoint = ptrtoint ptr %blk2 to i64
  store i64 %cast.ptrtoint, ptr %handle, align 4
  %handle3 = load i64, ptr %handle, align 4
  %addtmp = add i64 %handle3, 24
  %handle4 = load i64, ptr %handle, align 4
  %addtmp5 = add i64 %handle4, 24
  %cast.inttoptr = inttoptr i64 %addtmp5 to ptr
  store i64 32768, ptr %cast.inttoptr, align 4
  %blk6 = load ptr, ptr %blk, align 8
  call void @npk_free(ptr %blk6)
...
define linkonce_odr i32 @__test_store4_init() {
entry:
  ret i32 0
}
