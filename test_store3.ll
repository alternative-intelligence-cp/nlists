; ModuleID = 'bench/test_store3.npk'
source_filename = "bench/test_store3.npk"
...
entry:
  ...
  store ptr %blk1, ptr %ptr, align 8
  %ptr2 = load ptr, ptr %ptr, align 8
  store i64 32768, ptr %ptr2, align 4
  %blk3 = load ptr, ptr %blk, align 8
  call void @npk_free(ptr %blk3)
...
define linkonce_odr i32 @__test_store3_init() {
entry:
  ret i32 0
}
